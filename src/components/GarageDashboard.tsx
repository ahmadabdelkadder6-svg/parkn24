...
{(isOwner ? [
  ...
  <>
    ...
    {/* ✅ كل الإحصائيات المالية تظهر للمالك فقط */}
    {isOwner && (
      <>
        {/* الإيراد المؤكد */}
